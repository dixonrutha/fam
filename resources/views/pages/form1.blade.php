...
<!--background-->
    ...
    <div class="bg-agile">
        <div class="book-appointment" style=
        "top: 97px;position: relative;">
    ...
    -->
                        ...
                        <div class="phone_email" style="">
                            <div class="form-text">
                                ...
                                <input type="text" name="hela" placeholder="Kiasi cha Pesa  " required="">
                            </div>
                        </div>
                        <div class="phone_email" style="">
                            <div class="form-text">
        ...
        <!--        another form -->
        <div class="book-appointment" style="position: relative;top: 125px;">
            <h2>2:Uongozi</h2>
            <div class="book-form agileits-login">
