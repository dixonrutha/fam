...
@section('content')
 ...
 <!-- breadcrumb -->
	...
	<div class="why-choose-agile py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-light text-white text-center mb-5">Social
				...
				<div class="col-lg-6 services-agile-1">
					<div class="row wthree_agile_us">
						...
						<div class="col-9 agile-why-text-2">
							...
							<p style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;font-size: 15px;letter-spacing: 1px;line-height: 1.9;color: #000;">FAM ni kikundi cha kijamii, hivyo wanakikundi kwa pamoja wamekubaliana kushirikiana kwa pamoja kwenye shughuli mbali mbali za kijamii zikiwemo starehe na maafa. 
Kikundi kinawajibika kushiriki katika starehe ya wanachama mfano harusi, kumbukumbu ya kuzaliwa na kumzawadia, kumfariji anapougua, pamoja na kumpa pole anapofiwa na mtoto, mme/mke, baba/mama pamoja na kutoa rambi rambi kwa familia pale mwanachama anapofariki.
				...
				<div class="col-lg-6 services-agile-1 my-lg-0 my-5">
					<div class="row wthree_agile_us">
						...
						<div class="col-9 agile-why-text-2">
							<!--<h4 class="text-capitalize text-white font-weight-bold mb-3">Aidha kikundi kimejipanga kufungua vitegauhumi mbali mbali ili kukuza kipato</h4>-->
							<p style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;font-size: 15px;letter-spacing: 1px;line-height: 1.9;color: #000;">Aidha kikundi kitashiriki shughuli nyingine za jamii za nje y kikundi mfano matendo ya huruma - kuwatembelea wagonjwa pamoja na watoto yatima kuwafariji.</p>
