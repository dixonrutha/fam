...
@section('content')
 ...
 <!-- breadcrumb -->
	...
	<div class="why-choose-agile py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-light text-white text-center mb-5">Economical
				...
				<div class="col-lg-6 services-agile-1 my-lg-0 my-5">
					<div class="row wthree_agile_us">
						...
						<div class="col-9 agile-why-text-2">
							...
							<p style="margin: 0;padding: 0;font-family: 'Open Sans', sans-serif;font-size: 15px;letter-spacing: 1px;line-height: 1.9;color: #000;">	Kikundi cha FAM kimeundwa na wahandisi wa fani mbali mbali. Hivyo kupitia kitengo cha Projects wanachama hufanya tafiti mbali mbali kujua matatizo yaliyopo kwenye jamii na kukuyatafuta suluhisho kwa kutumia teknolojia ambapo tatizi hizo zitaziingizia kikundi kipato.</p>
