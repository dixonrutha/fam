...
<head>
    ...
    <!-- Style-Css -->
    <link href="{{asset('css/dixon.css')}}" media="all" rel="stylesheet" type="text/css" />
    <link href="{{asset('css/dixon2.css')}}" media="all" rel="stylesheet" type="text/css" />
    <!-- Font-Awesome-Icons-Css -->
    <link href="{{asset('css/fontawesome-all.css')}}" rel="stylesheet" />
    <link href="{{asset('css/preload.css')}}" rel="stylesheet" />
    <link href="{{asset('css/head2.css')}}" rel="stylesheet" />
    <link href="{{asset('css/loan2.css')}}" rel="stylesheet" />
    <link href="{{asset('css/loan5.css')}}" rel="stylesheet" />
...
<div class='thetop'></div>
 ...
 width: 143px;
  ...
  <script type="text/javascript" id="hs-script-loader" async defer src="//js.hs-scripts.com/6101466.js"></script>
...
<body>
 <div class="beko" id="animationWindow">
        ...
        <div class="container" id="co" style="height: 616px;">
            <canvas id="c" width="1920" height="616"></canvas>
            <h1 style="color:#fff"> Welcome To Fam Team</h1>
        </div>
    </div>
    ...
    <header>
        ...
        <!-- //top header -->
        <!-- middle header -->
        <div class="middle-w3ls-nav py-2 fixed-header" style="">
            <div class="container">
                <div class="row">
                                  <div class="logo-area">
							
								<a href="{{url('/')}}"><img src="{{asset('images/Logo.png')}}" style="" alt=""></a>
							</div>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-nav "><button
                ...
                <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
                    <ul class="navbar-nav justify-content-center">
                        ...
                        <li class="nav-item"><a class="nav-link " href="{{url('about')}}">About FAM</a></li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle " href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							Fam Activities
							</a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{url('economic')}}">Economical</a>
                                <a class="dropdown-item" href="{{url('social')}}">Social</a>
                                <a class="dropdown-item" href="{{url('education')}}">Educational</a>
                               
                                <div class="dropdown-divider"></div>
                               
                            </div>
                        </li>
                          <!--<li class="nav-item"><a class="nav-link " href="{{url('activities')}}">FAM Activities</a></li>-->
                        ...
                        <li class="nav-item dropdown"><a aria-expanded="false" aria-haspopup="true"
                            ...
                            <div class="dropdown-menu"><a class="dropdown-item" href="#">Documents</a> <a
                                        class="dropdown-item" href="{{url('/form2')}}">Register with FAM5</a>
